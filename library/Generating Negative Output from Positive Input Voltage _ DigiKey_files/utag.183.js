...
//tealium universal tag - utag.sender.3117 ut4.0.201602021453, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          "base_url" : "",
          "partition" : "www",
          "project_guid" : "3d60bbfe-3fa3-45c4-9332-cc1534d3e4bd",
          "ptc" : "/ptc/",
          "events" : []
        };
        ...
        if (u.initialized) {
          ...
          if (!u.scriptrequested) {
            ...
            u.loader({"type" : "script", "src" : u.data.base_url, "cb" : u.callBack, "loc" : "script", "id" : "utag_183"});
          }
        }

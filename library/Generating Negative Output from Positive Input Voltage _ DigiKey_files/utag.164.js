...
(function(id,loader,u){
  ...
  u.qs_delim="?";
  u.tag_type="script";
  u.base_url="//www.digikey.com/cookie-js-v9-compressed.js";
  u.static_params="";
  ...
  u.send=function(a,b){
	...
	if(c.length>0){
      ...
      if(u.tag_type=="img"){
        ...
        d=document.createElement("iframe");d.setAttribute('id','164');d.setAttribute('height','1');d.setAttribute('width','1');d.setAttribute('style','display:none');d.setAttribute('src',u.url+c.join(u.qsp_delim));document.body.appendChild(d);
      }
    }
  }
